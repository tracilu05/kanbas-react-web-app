    ...
    return (
      <div id="wd-lab1">
        ...
        <ol id="wd-your-favorite-recipe">
            <li>add 2 tbs of chia seeds in a jar.</li>
            <li>add 1/2 cup of coconut milk.</li>
            <li>add 1 tbs of honey.</li>
            <li>stir to combine.</li>
            <li>add slices strawberries and bluberries.</li>
            <li>refrigerate overnight.</li>
            <li>put granola bits on top and enjoy!</li>
        </ol>
...
<input type="date"
    ...
    <p> Please
    <a id="wd-github" href="https://github.com/tracilu05/kanbas-react-web-app">click here</a>
    to get github<br/></p>
